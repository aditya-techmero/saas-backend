...
class SemanticKeywords:
    """A collection of semantic keywords for SEO optimization."""
    ...
    def __init__(self, 
        ...
        self.long_tail_keywords = long_tail_keywords
        self.related_keywords = related_keywords
        self.total_count = len(primary_keywords) + len(secondary_keywords) + len(long_tail_keywords) + len(related_keywords)
    ...
    def get_all_keywords(self) -> List[str]:
        ...
        return self.primary_keywords + self.secondary_keywords + self.long_tail_keywords + self.related_keywords
